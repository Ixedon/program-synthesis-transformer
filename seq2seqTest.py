...
def create_dataset():
    ...
    texts = [preprocess_sentence(w) for w in programs['text']]
    programs_tokenized = []
    ...
    return programs_tokenized, texts


txt, pr = create_dataset()
print(txt[-1])
print(pr[-1])
...
# print(f"Wocab input size: {vocab_inp_size}")
# print(f"Wocab output size: {vocab_tar_size}")
...
# x[:10] = 0
# print(levenstein(target_tensor_train[0], x))
# exit(0)

# @tf.function
# def whole_loss(target_program, output_program):
#     loss = 0
#     for i in range(target_program.shape[0]):
#         loss += levenstein(target_program[i], output_program[i])
#     return loss
...
#
# translate("given an array of numbers what is first half of the given array")
# #TODO bleu to accurate translation